...
private RCardPane getCardPane2() {
	if (CardPane2 == null) {
		...
		CardPane2.addCard("TextArea", getTextArea());
	}
	return CardPane2;
}
...
private RTextArea getTextArea() {
	if (TextArea == null) {
		...
		TextArea.setText("Le montant de la voiture dépasse vos compétences, voulez-vous transmettre la demande à l'assurance?");
		TextArea.setEditable(false);
		TextArea.setPreferredSize(new com.ulcjava.base.application.util.Dimension(0,250));
